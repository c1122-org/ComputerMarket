    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li>
                <button class="btn btn-outline-danger"><a href="/computer?action=sort">Sort by producer</a></button>
                </li>
            </ul>
...
<div class="container-fluid mt-4" style="background-color: white">
    ...
    <h1>Máy Tính siêu rẽ <span class="badge rounded-pill bg-danger">Chợ Tốt - Chợ Mua Bán, Rao Vặt Trực Tuyến Hàng Đầu Của Người Việt</span></h1>
    ...
    <div id="carouselExampleCaptions" class="carousel" style="margin: 50px 150px">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://taiphanmempc.net/wp-content/uploads/2017/07/tai-hinh-nen-4k-cho-may-tinh.jpg" class="d-block w-100" alt="...">
            ...
            <div class="carousel-item">
                <img src="https://cdn.tgdd.vn/Files/2019/08/22/1190454/laptop-vien-man-hinh-mong-co-nhung-uu-va-nhuoc-diem-gi--6.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Apple</h5>
            ...
            <div class="carousel-item">
                <img src="https://cdn.nguyenkimmall.com/images/companies/_1/dell-vostro-5568-thiet-ke-dep.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
